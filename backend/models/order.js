...
const orderTable = new pgp.helpers.ColumnSet([
...
module.exports = class OrderModel {
  ...
  async create() {
    try {
      ...
      const statement = pgp.helpers.insert(order, orderTable) + ' RETURNING *';
  ...
  async update(data) {
    try {
      ...
      const statement = pgp.helpers.update(data, orderTable) + condition;
